if ( typeof wappalyzer != 'undefined' ) {
	...
	wappalyzer.apps = {
		...
		'Backbone.js':           { cats: { 1: 12 }, html: /<script[^>]* src=("|')[^>]*backbone[^>]*\.js/i, js: 'window.Backbone', env: /^Backbone$/ },
		...
		'd3':                    { cats: { 1:  5 }, html: /<script[^>]*src=[^>]+d3[^>]*\.js/i, js: 'window.d3' },
		...
		'Protovis':           { cats: { 1:  5 }, html: /<script[^>]* src=("|')[^>]*protovis[^>]*\.js/i, js: 'window.pv', env: /^protovis$/ },
		...
		'Raphael.js':            { cats: { 1:  5 }, html: /<script[^>]* src=("|')[^>]*raphael[^>]*\.js/i, js: 'window.Raphael', env: /^Raphael$/ },
		...
		'Typekit':               { cats: { 1: 17 }, html: /<script[^>]* src=("|')[^>]*use.typekit.com/i, js: 'window.Typekit', env: /^Typekit$/ },
		...
		'Underscore.js':         { cats: { 1: 12 }, html: /<script[^>]* src=("|')[^>]*underscore[^>]*\.js/i, js: 'window._.VERSION', env: /^_.VERSION$/ },
