(function() {
	...
	w.apps = {
		...
		'David Webbox':          { cats: { 1: 22 }, headers: { 'Server': /David-WebBox/i } },
		...
		'Google Font API':       { cats: { 1: 17 }, script: /googleapis.com\/.+webfont/, html: /<link[^>]* href=("|')http:\/\/fonts\.googleapis\.com/, env: /^WebFont/ },
		...
		'SiteCatalyst':          { cats: { 1: 10 }, html: /var s_code=s\.t\(\);if\(s_code\)document\.write\(s_code\)/i, env: /^s_account$/ },
